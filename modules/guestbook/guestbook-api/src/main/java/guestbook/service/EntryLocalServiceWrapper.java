...
public class EntryLocalServiceWrapper implements EntryLocalService,
	...
	*/
	@Override
	public guestbook.model.Entry addEntry(guestbook.model.Entry entry) {
	...
	*/
	@Override
	public guestbook.model.Entry createEntry(long entryId) {
	...
	*/
	@Override
	public guestbook.model.Entry deleteEntry(guestbook.model.Entry entry) {
	...
	*/
	...
	@Override
	public guestbook.model.Entry fetchEntry(long entryId) {
	...
	*/
	@Override
	public guestbook.model.Entry fetchEntryByUuidAndGroupId(
	...
	*/
	@Override
	public guestbook.model.Entry getEntryByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public java.util.List<guestbook.model.Entry> getEntries(int start, int end) {
	...
	*/
	@Override
	public java.util.List<guestbook.model.Entry> getEntriesByUuidAndCompanyId(
