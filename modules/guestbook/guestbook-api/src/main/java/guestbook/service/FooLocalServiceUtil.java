 ...
 * {@link guestbook.service.impl.FooLocalServiceImpl} and is the
 ...
 * @see FooLocalService
 * @see guestbook.service.base.FooLocalServiceBaseImpl
 * @see guestbook.service.impl.FooLocalServiceImpl
 * @generated
 */
@ProviderType
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link guestbook.service.impl.FooLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static guestbook.model.Foo addFoo(guestbook.model.Foo foo) {
	...
	* @return the new foo
	*/
	public static guestbook.model.Foo createFoo(long fooId) {
	...
	*/
	public static guestbook.model.Foo deleteFoo(guestbook.model.Foo foo) {
	...
	*/
	public static guestbook.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteFoo(fooId);
	}

	public static guestbook.model.Foo fetchFoo(long fooId) {
	...
	* @throws PortalException if a foo with the primary key could not be found
	*/
	public static guestbook.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static guestbook.model.Foo getFooByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static guestbook.model.Foo updateFoo(guestbook.model.Foo foo) {
	...
	*/
	public static java.util.List<guestbook.model.Foo> getFoos(int start, int end) {
	...
	*/
	public static java.util.List<guestbook.model.Foo> getFoosByUuidAndCompanyId(
	...
	*/
	public static java.util.List<guestbook.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<guestbook.model.Foo> orderByComparator) {
		return getService()
