 ...
 * {@link guestbook.service.impl.EntryLocalServiceImpl} and is the
 ...
 * @see guestbook.service.base.EntryLocalServiceBaseImpl
 * @see guestbook.service.impl.EntryLocalServiceImpl
 * @generated
 */
@ProviderType
public class EntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link guestbook.service.impl.EntryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static guestbook.model.Entry addEntry(guestbook.model.Entry entry) {
		return getService().addEntry(entry);
	}

	public static guestbook.model.Entry addEntry(long userId, long guestbookId,
	...
	*/
	public static guestbook.model.Entry createEntry(long entryId) {
	...
	*/
	public static guestbook.model.Entry deleteEntry(guestbook.model.Entry entry) {
	...
	*/
	public static guestbook.model.Entry deleteEntry(long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static guestbook.model.Entry fetchEntry(long entryId) {
	...
	*/
	public static guestbook.model.Entry fetchEntryByUuidAndGroupId(
	...
	* @throws PortalException if a entry with the primary key could not be found
	*/
	public static guestbook.model.Entry getEntry(long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static guestbook.model.Entry getEntryByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static guestbook.model.Entry updateEntry(guestbook.model.Entry entry) {
		return getService().updateEntry(entry);
	}

	public static guestbook.model.Entry updateEntry(long userId,
	...
	*/
	public static java.util.List<guestbook.model.Entry> getEntries(int start,
		int end) {
		return getService().getEntries(start, end);
	}

	public static java.util.List<guestbook.model.Entry> getEntries(
	...
	*/
	public static java.util.List<guestbook.model.Entry> getEntriesByUuidAndCompanyId(
	...
	*/
	public static java.util.List<guestbook.model.Entry> getEntriesByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<guestbook.model.Entry> orderByComparator) {
		return getService()
