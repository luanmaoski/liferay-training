...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<guestbook.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public guestbook.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public guestbook.model.Entry toUnescapedModel() {
		return new EntryWrapper(_entry.toUnescapedModel());
	}

	@Override
	public int compareTo(guestbook.model.Entry entry) {
