 ...
 * @see FooModel
 * @see guestbook.model.impl.FooImpl
 * @see guestbook.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("guestbook.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link guestbook.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
