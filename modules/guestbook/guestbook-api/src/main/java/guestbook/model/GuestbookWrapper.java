...
public class GuestbookWrapper implements Guestbook, ModelWrapper<Guestbook> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<guestbook.model.Guestbook> toCacheModel() {
		return _guestbook.toCacheModel();
	}

	@Override
	public guestbook.model.Guestbook toEscapedModel() {
		return new GuestbookWrapper(_guestbook.toEscapedModel());
	}

	@Override
	public guestbook.model.Guestbook toUnescapedModel() {
		return new GuestbookWrapper(_guestbook.toUnescapedModel());
	}

	@Override
	public int compareTo(guestbook.model.Guestbook guestbook) {
