...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<guestbook.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public guestbook.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public guestbook.model.Foo toUnescapedModel() {
		return new FooWrapper(_foo.toUnescapedModel());
	}

	@Override
	public int compareTo(guestbook.model.Foo foo) {
