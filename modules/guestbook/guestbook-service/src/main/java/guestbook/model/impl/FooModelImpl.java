...
import guestbook.model.FooModel;
import guestbook.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(guestbook.service.util.ServiceProps.get(
				"lock.expiration.time.guestbook.model.Foo"));
