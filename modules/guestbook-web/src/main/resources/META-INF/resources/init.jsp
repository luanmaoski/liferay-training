...
<%@ page import="guestbook.service.EntryLocalServiceUtil" %>
<%@ page import="guestbook.service.GuestbookLocalServiceUtil" %>
<%@ page import="guestbook.model.Entry" %>
<%@ page import="search.service.permission.GuestbookModelPermission" %>
